...
def create_app() -> FastAPI:
    ...
    from .routers import lead_qual as lead_qual_router, n8n_hooks as n8n_router, exports as exports_router, prospects as prospects_router, costs as costs_router
