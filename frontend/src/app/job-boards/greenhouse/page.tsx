      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="rounded-lg border border-white/10 bg-white/5 backdrop-blur p-6 shadow-2xl shadow-black/20">
          ...
          <div className="mt-1 text-sm text-white/70">
            In-app search for company job boards hosted on Greenhouse. Query: <span className="font-semibold text-white">{queryLabel}</span>
          </div>
          ...
          <div className="mt-6">
            {loading ? (
              ...
              <div className="text-sm text-white/70">
                No results yet. If this keeps happening, set <code>SERPER_API_KEY</code> on the backend to enable the in-app search.
              </div>
            ) : null}
          </div>
        </div>
