  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-lg rounded-lg border border-white/10 bg-neutral-900/95 backdrop-blur shadow-xl overflow-hidden">
          ...
          <div className="p-3 grid grid-cols-1 gap-2">
            ...
            <a className="px-3 py-2 rounded bg-white/10 hover:bg-white/15" href="http://localhost:8000/docs" target="_blank">API Docs (OpenAPI)</a>
